...
class DatabaseController extends CommonController {
    ...
    public function index($type = null){
        switch ($type) {
            ...
            case 'import':
                ...
                $list = $this->my_sort($list,'time',SORT_DESC);
                //$this->_echopage($list,'list');
    ...
    /**
     * 二维数组排序
     * @param  [type] $arrays     [二维数组]
     * @param  [type] $sort_key   [按照排序的键名称]
     * @param  [type] $sort_order [排序方式。SORT_ASC 正序，SORT_DESC倒序]
     * @param  [type] $sort_type  [排序参照。]
     * @return [type]             [排序后的数组]
     */
