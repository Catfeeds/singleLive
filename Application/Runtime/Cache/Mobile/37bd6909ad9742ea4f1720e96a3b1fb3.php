...
<body>
    ...
    <div class="addWrap">
        <div class="swipe" id="mySwipe">
            <div class="swipe-wrap">
                <div><a href="javascript:;"><img class="img-responsive" src="/Public/Mobile/img/myct01@2x.png"/></a></div>
                <div><a href="javascript:;"><img class="img-responsive" src="/Public/Mobile/img/myct01@2x.png" /></a></div>
                <div><a href="javascript:;"><img class="img-responsive" src="/Public/Mobile/img/myct01@2x.png"/></a></div>
                <div><a href="javascript:;"><img class="img-responsive" src="/Public/Mobile/img/myct01@2x.png" /></a></div>
            </div>
    ...
    <div class="app_lint">
        <div class="app_Guest_cont flow-default" id="LAY_demo1">
            <a href="/index.php/Mobile/Index/restaurantEdit" class="Guest">
                <div class="Guest_left">
                    <img src="/Public/Mobile/img/ct01@2x.png">
                </div>
