...
<body>
    ...
    <div class="addWrap">
        <div class="swipe" id="mySwipe">
            <div class="swipe-wrap">
                <div><a href="javascript:;"><img class="img-responsive" src="/Public/Mobile/img/tc01@2x.png"/></a></div>
                <div><a href="javascript:;"><img class="img-responsive" src="/Public/Mobile/img/tc01@2x.png" /></a></div>
                <div><a href="javascript:;"><img class="img-responsive" src="/Public/Mobile/img/tc01@2x.png"/></a></div>
                <div><a href="javascript:;"><img class="img-responsive" src="/Public/Mobile/img/tc01@2x.png" /></a></div>
            </div>
    ...
    <div class="app_lint">
        ...
        <div class="app_Guest_cont flow-default" id="LAY_demo1">
            <a href="/index.php/Mobile/Index/packageEdit" class="Guest">
                <div class="Guest_left">
                    <img src="/Public/Mobile/img/hj02@2x.png">
                </div>
                <div class="Guest_right1">
                    <span><img src="/Public/Mobile/img/my05@2x.png"></span>
                    <h3>在树屋中共度浪漫纪念日</h3>
                    <b>简介：尊贵城堡树屋尊贵城堡树屋尊贵城堡树屋尊贵城堡树屋尊贵城堡树屋尊 贵城堡树屋尊 贵城堡树屋尊  </b>
                    <h2>￥699.00</h3>
	     	  </div>
	     </a>
    </div>
